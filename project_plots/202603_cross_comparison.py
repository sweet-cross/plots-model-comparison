...
folder_plots = "presentation_latex/figures_2026_03_18"
...
signedVarList_supply_use = [
    ...
    },
    {
        "name": "Methane",
        "varName": "electricity_supply_typical_day",
        "techs": ["methane_pp", "fuel_cell_methane"],
        "sign": +1,
        "color": "#1f6228",
    },
    {
        "name": "Hydrogen",
        "varName": "electricity_supply_typical_day",
        "techs": ["hydrogen_pp", "fuel_cell_h2"],
        "sign": +1,
        "color": "#03CBA0",
    },
    {
    ...
    {
        "name": "Power to liquids",
        "varName": "electricity_consumption_typical_day",
        "techs": ["power_to_liquid"],
        "sign": -1,
        "color": "#4B4EFC",
    },
    {
...
varList_h2_consump = [
    ...
    {
        "name": "Passengers",
        "data": ["passenger_road_public", "passenger_road_private"],
        "color": "#09c5c9",
    },
...
varList_methane_supply = [
    ...
    {
        "name": "Gasification",
        "data": ["wood_gasification_methane", "waste_gasification_methane"],
        "color": "#a9807c",
    },
