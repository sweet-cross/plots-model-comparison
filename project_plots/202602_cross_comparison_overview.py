...
model_list = [
    ...
    # {'name': 'Nexus-e+\nEP2050+', 'file': 'resultsCross_Nexuse-EP','summer':'Jul 02','winter':'Feb 08','color':'#BCBD21'},
    {
        ...
        "id": "ehub",
        "summer": "Week day",
        "summerDay": "01.07.2050",
        "winter": "Week day",
        "winterDay": "01.02.2050",
        "color": "#8B5349",
    },
    {
        "name": "SecMod",
...
scenario_groups = {
    ...
    "All": [
        ("abroad-res-full", "reference"),
        ("abroad-res-lim", "reference"),
        ("domestic-res-full", "reference"),
        ("domestic-res-lim", "reference"),
        ("abroad-nores-full", "reference"),
        ("abroad-nores-lim", "reference"),
        ("domestic-nores-full", "reference"),
        ("domestic-nores-lim", "reference"),
    ],
}
...
listModels = (
    cross_plots.modelsid
)  # any model can be excluded, the list should include the model ids
...
varList_supply_net = [
    ...
    {
        "name": "Methane",
        "data": ["methane_pp", "fuel_cell_methane"],
        "color": "#1f6228",
    },
...
varList_use_net = [
    ...
    {
        "name": "Road transport",
        "data": ["road_public", "road_private", "truck", "ldv"],
        "color": "#09c5c9",
    },
    {
        "name": "Space heating",
...
signedVarList_supply_use = [
    ...
    {
        "name": "Base",
        "varName": "electricity_consumption_typical_day",
        "techs": ["elec_appliances"],
        "sign": -1,
        "color": "#097F6D",
    },
    {
        "name": "Trains",
        "varName": "electricity_consumption_typical_day",
        "techs": ["passenger_rail", "freight_rail"],
        "sign": -1,
        "color": "#066256",
    },
    {
        "name": "Others",
        "varName": "electricity_consumption_typical_day",
        "techs": ["dac", "data_centers", "power_to_liquid"],
        "sign": -1,
        "color": "#9751CB",
    },
    {
        "name": "Losses",
        "varName": "electricity_consumption_typical_day",
        "techs": ["grid_losses", "storage_losses"],
        "sign": -1,
        "color": "#8B5A2B",
    },
    {
    ...
    },
    {
        "name": "Road transport",
        "varName": "electricity_consumption_typical_day",
        "techs": ["road_public", "road_private", "truck", "ldv"],
        "sign": -1,
        "color": "#09c5c9",
    },
    {
...
listModels_elec = ["powercheck"]
listModels_energy = [m for m in cross_plots.modelsid if m not in listModels_elec]
...
varList_h2_supply = [
    ...
    {
        "name": "Gasification",
        "data": ["wood_gasification_h2", "waste_gasification_h2"],
        "color": "#a9807c",
    },
...
cross_plots.plotBarHorizontal(
    # cross_plots.plotBarVertical(
    listModelsid=listModels_energy,
    listSce=scenarios,
    varName=varName,
...
varList_h2_consump = [
    {
        "name": "Electricity",
        "data": ["hydrogen_pp", "fuel_cell_h2"],
        "color": "#9751CB",
    },
    {"name": "Freight", "data": ["freight_road"], "color": "#8B5349"},
    {"name": "Passengers", "data": ["passenger"], "color": "#09c5c9"},
...
varList_methane_supply = [
    {
        ...
        "data": ["anaerobic_digestion"],
        "color": "#1f6228",
    },
    {"name": "Gasification", "data": ["gasification_methane"], "color": "#a9807c"},
...
varList_liquids_supply = [
    ...
    {
        "name": "Liquefaction",
        "data": ["wood_liquefaction", "waste_liquefaction"],
        "color": "#a9807c",
    },
    {
        "name": "Imports",
        "data": ["imports_diesel", "imports_biodiesel"],
        "color": "#CCCCCC",
    },
]
...
varList_spaceHeat = [
    ...
    {
        "name": "Heaters",
        "data": ["heater_elec", "boiler_electrode"],
        "color": "#FF6F31",
    },
