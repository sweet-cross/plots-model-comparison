...
model_list = [
    ...
    # {'name': 'Expanse', 'file': 'resultsCross_Expanse','summer':'Jul 02','winter':'Jan 01','color':'#FF7D0D'},
    {
        ...
        "id": "nexuse",
        "summer": "Typical day",
        "summerDay": "02.07.2050",
        "winter": "Typical day",
        "winterDay": "08.02.2050",
        "color": "#BCBD21",
    },
...
sce = [
    "abroad-resnuc-high",
    "abroad-resnuc-medium",
    "abroad-resnuc-low",
    "abroad-resnuc-phaseout",
    "abroad-res-high",
    "abroad-res-medium",
    "abroad-res-low",
    "abroad-res-phaseout",
    ...
    "Liquids": [
        {
            ...
            "techs": ["imports_diesel", "imports_biodiesel"],
            "sign": +1,
            "color": "#cccccc",
        },
        {
    ...
    "Methane": [
        {
            ...
            "techs": ["imports_gas", "imports_methane"],
            "sign": +1,
            "color": "#cccccc",
        },
        {
